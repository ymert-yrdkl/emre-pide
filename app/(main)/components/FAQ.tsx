    ...
    <section ref={sectionRef} id="sss" className="bg-background px-6 py-24 scroll-mt-20 overflow-x-hidden lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="font-[family-name:var(--font-serif)] text-[clamp(2.2rem,4vw,3.1rem)] leading-tight text-foreground">
            Sıkça Sorulan <em className="italic text-primary">Sorular</em>
          </h2>
        </div>

        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_420px] xl:grid-cols-[minmax(0,1fr)_480px] xl:gap-12">
          <div className="rounded-[36px] border border-border bg-white p-7 shadow-sm md:p-10 lg:p-12">
          ...
          <div className="relative hidden min-h-[560px] overflow-hidden rounded-[36px] border border-gold/15 bg-koyu lg:block">
            ...
            <div className="absolute inset-x-10 top-10 max-w-xs">
              <span className="text-[0.72rem] font-semibold uppercase tracking-[0.18em] text-gold">
                Öne çıkan cevaplar
              </span>
              <p className="mt-4 text-[0.96rem] leading-8 text-krem/65">
                Paket servis, çalışma saatleri ve toplu sipariş gibi en kritik sorular burada kısa ve net şekilde cevaplanır.
              </p>
            </div>
            <div className="absolute inset-y-12 right-0 w-[240px] rounded-l-full border border-gold/25 border-r-0" />
            <div className="absolute inset-y-24 right-10 w-[170px] rounded-l-full border border-gold/10 border-r-0" />
            <div
              className="absolute bottom-[-24px] right-[-70px] h-[360px] w-[360px]"
              style={{
