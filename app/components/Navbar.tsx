...
export default function Navbar() {
    ...
    return (
        <>
            <nav
                className={`fixed top-0 left-0 right-0 z-[200] flex justify-between items-center px-[5%] py-5 transition-all duration-300 border-b ${scrolled
                        ? "nav-scrolled bg-koyu/98 border-gold/30"
                        : "bg-koyu/95 border-gold/20"
                    }`}
